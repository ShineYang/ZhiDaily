...
//        marginParams.setMargins(0, (int) getContext().getResources().getDimension(R.dimen.bottom_navigation_top_margin_correction), 0, 0);
        ...
        parentView = inflater.inflate(R.layout.bottom_navigation_bar_container, this, true);
    ...
    public void initBlurView(Context context, View decorView) {
        ...
        blurView.setupWith(rootView)
                ...
                .blurAlgorithm(new RenderScriptBlur(context, true)) //Optional, enabled by default. User can have custom implementation
                .blurRadius(radius);
    }
